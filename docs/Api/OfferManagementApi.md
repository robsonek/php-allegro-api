# robsonek\phpAllegroApi\OfferManagementApi
...
```php
changePublicationStatusUsingPUT($command_id, $publication_change_command_dto): \robsonek\phpAllegroApi\Model\GeneralReport
```
...
$apiInstance = new robsonek\phpAllegroApi\Api\OfferManagementApi(
...
$publication_change_command_dto = new \robsonek\phpAllegroApi\Model\PublicationChangeCommandDto(); // \robsonek\phpAllegroApi\Model\PublicationChangeCommandDto | publicationChangeCommandDto
...
| **publication_change_command_dto** | [**\robsonek\phpAllegroApi\Model\PublicationChangeCommandDto**](../Model/PublicationChangeCommandDto.md)| publicationChangeCommandDto | |
...
```php
createChangePriceCommandUsingPUT($offer_id, $command_id, $change_price_without_output): \robsonek\phpAllegroApi\Model\ChangePrice
```
...
$change_price_without_output = new \robsonek\phpAllegroApi\Model\ChangePriceWithoutOutput(); // \robsonek\phpAllegroApi\Model\ChangePriceWithoutOutput
...
| **change_price_without_output** | [**\robsonek\phpAllegroApi\Model\ChangePriceWithoutOutput**](../Model/ChangePriceWithoutOutput.md)|  | |

### Return type

[**\robsonek\phpAllegroApi\Model\ChangePrice**](../Model/ChangePrice.md)
...
```php
createProductOffers($sale_product_offer_request_v1): \robsonek\phpAllegroApi\Model\SaleProductOfferResponseV1
```
...
$sale_product_offer_request_v1 = new \robsonek\phpAllegroApi\Model\SaleProductOfferRequestV1(); // \robsonek\phpAllegroApi\Model\SaleProductOfferRequestV1
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **sale_product_offer_request_v1** | [**\robsonek\phpAllegroApi\Model\SaleProductOfferRequestV1**](../Model/SaleProductOfferRequestV1.md)|  | |
...
```php
editProductOffers($offer_id, $sale_product_offer_patch_request_v1): \robsonek\phpAllegroApi\Model\SaleProductOfferResponseV1
```
...
$offer_id = 'offer_id_example'; // string | The offer identifier.
$sale_product_offer_patch_request_v1 = new \robsonek\phpAllegroApi\Model\SaleProductOfferPatchRequestV1(); // \robsonek\phpAllegroApi\Model\SaleProductOfferPatchRequestV1
...
| ------------- | ------------- | ------------- | ------------- |
| **offer_id** | **string**| The offer identifier. | |
| **sale_product_offer_patch_request_v1** | [**\robsonek\phpAllegroApi\Model\SaleProductOfferPatchRequestV1**](../Model/SaleProductOfferPatchRequestV1.md)|  | |
...
```php
getAvailableOfferPromotionPackages(): \robsonek\phpAllegroApi\Model\AvailablePromotionPackages
```
...
[**\robsonek\phpAllegroApi\Model\AvailablePromotionPackages**](../Model/AvailablePromotionPackages.md)
...
```php
getOfferPromoOptionsUsingGET($offer_id): \robsonek\phpAllegroApi\Model\OfferPromoOptions
```
...
[**\robsonek\phpAllegroApi\Model\OfferPromoOptions**](../Model/OfferPromoOptions.md)
...
```php
getOffersUnfilledParametersUsingGET1($offer_id, $parameter_type, $offset, $limit): \robsonek\phpAllegroApi\Model\UnfilledParametersResponse
```
...
[**\robsonek\phpAllegroApi\Model\UnfilledParametersResponse**](../Model/UnfilledParametersResponse.md)
...
```php
getProductOfferProcessingStatus($offer_id, $operation_id): \robsonek\phpAllegroApi\Model\SaleProductOfferStatusResponse
```
...
[**\robsonek\phpAllegroApi\Model\SaleProductOfferStatusResponse**](../Model/SaleProductOfferStatusResponse.md)
...
```php
getPromoModificationCommandDetailedResultUsingGET($command_id, $limit, $offset): \robsonek\phpAllegroApi\Model\PromoModificationReport
```
...
[**\robsonek\phpAllegroApi\Model\PromoModificationReport**](../Model/PromoModificationReport.md)
...
```php
getPromoModificationCommandResultUsingGET($command_id): \robsonek\phpAllegroApi\Model\PromoGeneralReport
```
...
[**\robsonek\phpAllegroApi\Model\PromoGeneralReport**](../Model/PromoGeneralReport.md)
...
```php
getPromoOptionsForSellerOffersUsingGET($limit, $offset): \robsonek\phpAllegroApi\Model\OfferPromoOptionsForSeller
```
...
[**\robsonek\phpAllegroApi\Model\OfferPromoOptionsForSeller**](../Model/OfferPromoOptionsForSeller.md)
...
```php
getPublicationReportUsingGET($command_id): \robsonek\phpAllegroApi\Model\GeneralReport
```
...
```php
getPublicationTasksUsingGET($command_id, $limit, $offset): \robsonek\phpAllegroApi\Model\TaskReport
```
...
```php
modifyOfferPromoOptionsUsingPOST($offer_id, $promo_options_modifications): \robsonek\phpAllegroApi\Model\OfferPromoOptions
```
...
$offer_id = 9991337999; // string | Offer identifier.
$promo_options_modifications = new \robsonek\phpAllegroApi\Model\PromoOptionsModifications(); // \robsonek\phpAllegroApi\Model\PromoOptionsModifications | request
...
| ------------- | ------------- | ------------- | ------------- |
| **offer_id** | **string**| Offer identifier. | |
| **promo_options_modifications** | [**\robsonek\phpAllegroApi\Model\PromoOptionsModifications**](../Model/PromoOptionsModifications.md)| request | |
...
```php
promoModificationCommandUsingPUT($command_id, $promo_options_command): \robsonek\phpAllegroApi\Model\PromoGeneralReport
```
...
$promo_options_command = new \robsonek\phpAllegroApi\Model\PromoOptionsCommand(); // \robsonek\phpAllegroApi\Model\PromoOptionsCommand | Promo packages modification command request.
...
| **promo_options_command** | [**\robsonek\phpAllegroApi\Model\PromoOptionsCommand**](../Model/PromoOptionsCommand.md)| Promo packages modification command request. | |
