...
**parameters** | [**\OpenAPI\Client\Model\ParameterProductOfferRequest[]**](ParameterProductOfferRequest.md) | List of product parameters. | [optional]
**images** | **string[]** | List of product images. | [optional]
**name** | **string** | Product name. | [optional]
**category** | [**\OpenAPI\Client\Model\Category**](Category.md) | Product category | [optional]
