...
class BadgeApplicationProcess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'rejection_reasons' => '\robsonek\phpAllegroApi\Model\BadgeApplicationRejectionReason[]'
    ];
    ...
    */
     ...
     *
     * @return \robsonek\phpAllegroApi\Model\BadgeApplicationRejectionReason[]
     */
     ...
     *
     * @param \robsonek\phpAllegroApi\Model\BadgeApplicationRejectionReason[] $rejection_reasons A list of rejection reasons for the badge application. Returned for process.status = DECLINED only.
     *
     * @return self
     */
