# robsonek\phpAllegroApi\TaxSettingsApi
...
```php
getTaxSettingsForCategory($category_id, $country_code): \robsonek\phpAllegroApi\Model\CategoryTaxSettings
```
...
$apiInstance = new robsonek\phpAllegroApi\Api\TaxSettingsApi(
...
[**\robsonek\phpAllegroApi\Model\CategoryTaxSettings**](../Model/CategoryTaxSettings.md)
