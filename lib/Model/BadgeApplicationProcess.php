...
class BadgeApplicationProcess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'rejection_reasons' => '\OpenAPI\Client\Model\BadgeApplicationRejectionReason[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\BadgeApplicationRejectionReason[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BadgeApplicationRejectionReason[] $rejection_reasons A list of rejection reasons for the badge application. Returned for process.status = DECLINED only.
     *
     * @return self
     */
