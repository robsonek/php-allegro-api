...
class ImagesAndAttachmentsApi
{
    ...
    /**
     * Operation getOfferAttachment
     *
     * Get offer attachment details
     *
     * @param  string $attachment_id The ID of the attachment. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOfferAttachment'] to see the possible values for this operation
     *
     * @throws \robsonek\phpAllegroApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \robsonek\phpAllegroApi\Model\OfferAttachment
     */
    public function getOfferAttachment($attachment_id, string $contentType = self::contentTypes['getOfferAttachment'][0])
    {
        list($response) = $this->getOfferAttachmentWithHttpInfo($attachment_id, $contentType);
        return $response;
    }

    /**
     * Operation getOfferAttachmentWithHttpInfo
     *
     * Get offer attachment details
     *
     * @param  string $attachment_id The ID of the attachment. (required)
     ...
     * @return array of \robsonek\phpAllegroApi\Model\OfferAttachment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferAttachmentWithHttpInfo($attachment_id, string $contentType = self::contentTypes['getOfferAttachment'][0])
    {
        $request = $this->getOfferAttachmentRequest($attachment_id, $contentType);
    ...
    /**
     * Operation getOfferAttachmentAsync
     *
     * Get offer attachment details
     *
     * @param  string $attachment_id The ID of the attachment. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOfferAttachmentAsync($attachment_id, string $contentType = self::contentTypes['getOfferAttachment'][0])
    {
        return $this->getOfferAttachmentAsyncWithHttpInfo($attachment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOfferAttachmentAsyncWithHttpInfo
     *
     * Get offer attachment details
     *
     * @param  string $attachment_id The ID of the attachment. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOfferAttachmentAsyncWithHttpInfo($attachment_id, string $contentType = self::contentTypes['getOfferAttachment'][0])
    {
        $returnType = '\robsonek\phpAllegroApi\Model\OfferAttachment';
        $request = $this->getOfferAttachmentRequest($attachment_id, $contentType);
    ...
    /**
     * Create request for operation 'getOfferAttachment'
     *
     * @param  string $attachment_id The ID of the attachment. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOfferAttachment'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOfferAttachmentRequest($attachment_id, string $contentType = self::contentTypes['getOfferAttachment'][0])
    {

        // verify the required parameter 'attachment_id' is set
        if ($attachment_id === null || (is_array($attachment_id) && count($attachment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attachment_id when calling getOfferAttachment'
            );
        }
